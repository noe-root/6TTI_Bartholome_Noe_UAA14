...
namespace _6TTI_Bartholome_Classification_de_triangles
{
    ...
    {
        // Procédure qui permet de préparer et renvoyer une phrase dans un string 'infos'
        // montrant l'état du triangle selon les situations se trouvant dans 'methode' (triangle / equilateral / isocèle / rectangle)
        // et un booléen 'ok' pour affirmer ou nier.
        public static void PrepareAffichage(bool ok,string methode,out string infos)//nommée PrepareAffichage
        {
            string verbe;
            infos = "";
        ...
        public static double Hypo(double x,double y)// ... nommée Hypo
        {
            double z = Math.Sqrt(Math.Pow(x, 2) + Math.Pow(y, 2));
            return z;
        }
        // fonction qui permet de déterminer si oui ou non un triangle est rectangle en se basant sur ses 3 côtés
        public static bool TriangleRectangle(double a,double b,double c)  // nommée TriangleRectangle
        {
            bool ok = false;
        ...
        public static void OrdonneCotes(ref double a, ref double b, ref double c)  // nommée ... OrdonneCotes
        {
            double temp;
        ...
        public static bool Triangle(double a, double b, double c) // nommée ...Triangle
        {
            bool ok = false;
        ...
        public static void Isocele(double a, double b, double c,ref bool ok)  // nommée Isocele
        {
            ok = false;
        ...
        public static bool Equi(double a, double b, double c)  // nommée Equi
        {
            bool ok = false;
            if ((a == b) && (a == c))
            {
